 ...
 *
 */
public class SelfCircleRandomTargetSelector extends SelfCircleTargetSelector
{
	private static final Logger mLogger = Logger.getLogger(SelfCircleRandomTargetSelector.class);
