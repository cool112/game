 ...
 *
 */
public class EffectModifiedBuffPrototype extends AbstractBuffPrototype
{
	...
	public SkillError onStart(EffectEntity effect, long currTime)
	{
		...
		for(GameObject target : targets)
		{
			...
			else
			{
				...
				{
					troopTarget.getAttrModList().addModifiedValue(type, effect, new ModifiedValueKey(MathUtil.getHashCode(ModifiedValueKey.EFFECT_TYPE, effectId), 0, 0), FixValue.valueOf(calType, value));
				}
			}
