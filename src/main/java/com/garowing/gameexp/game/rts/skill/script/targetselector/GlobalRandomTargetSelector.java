 ...
 *
 */
public class GlobalRandomTargetSelector extends GlobalTargetSelector
{
	private static final Logger mLogger = Logger.getLogger(GlobalRandomTargetSelector.class);
